                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', () => {
                            ...
                            function updatePaymentMethod() {
                                ...
                                // 1. Actualizar el estilo "selected" en la opción de pago
                                paymentOptions.forEach(option => {
                                    const radio = option.querySelector('input[type="radio"]');
                                    // Usa el valor del radio para identificar qué opción está seleccionada
                                ...
                                // 2. Mostrar/Ocultar los detalles del formulario correspondiente
